fn main() {
    println!("Patterns Locations");
    patterns_locations();
    println!();

    println!("Ir/refutable Patterns");
    ir_refutable_patterns();
    println!();
...
fn pattern_syntax() {
    ...
    match msg {
        NewMessage::ChangeColor(Color::_Rgb(r, g, b)) => println!(
    ...
    let msg = NewNewMessage::Hello{ id: 5 };
    match msg {
        NewNewMessage::Hello{ id: id_variable @ 3..=7 } => println!("Found an id in range: {}", id_variable),
        NewNewMessage::Hello{ id: 10..=12 } => {
            println!("Found an id in another range")
        }
        NewNewMessage::Hello{ id } => println!("Found some other id: {}", id),
    }
}
